...
public interface HikariConfigMXBean {
   /**
    * Get the maximum number of milliseconds that a client will wait for a connection from the
    * pool. If this
   ...
   /**
    * Get the maximum number of milliseconds that the pool will wait for a connection to be
    * validated as
    * alive.
    *
    ...
    * allowed to sit
    * idle in the pool. Whether a connection is retired as idle or not is subject to a maximum
    * variation of +30
    * seconds, and average variation of +15 seconds. A connection will never be retired as idle
    * before this timeout.
    ...
    * reaches this
    * timeout, even if recently used, it will be retired from the pool. An in-use connection will
    * never be
    ...
    * idle and in-use
    * connections. Basically this value will determine the maximum number of actual connections
    * to the database
    * backend.
    * <p>
    * When the pool reaches this size, and no idle connections are available, calls to
    * getConnection() will
   ...
   /**
    * The property controls the minimum number of idle connections that HikariCP tries to
    * maintain in the pool,
    * including both idle and in-use connections. If the idle connections dip below this value,
    * HikariCP will
    ...
    * connections only.
    * Altering this at runtime only works for DataSource-based connections, not Driver-class or
    * JDBC URL-based
    * connections.
    *
