...
public final class CodaHaleMetricsTracker extends MetricsTracker {
   ...
   public CodaHaleMetricsTracker(final String poolName, final PoolStats poolStats,
      ...
      registry
         .register(MetricRegistry.name(poolName, "pool", "TotalConnections"), new Gauge<Integer>() {
            @Override
      ...
      registry
         .register(MetricRegistry.name(poolName, "pool", "IdleConnections"), new Gauge<Integer>() {
            @Override
            public Integer getValue() {
