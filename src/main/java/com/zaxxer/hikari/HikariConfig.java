...
public class HikariConfig implements HikariConfigMXBean {
   ...
   static {
      // POOL_NUMBER is global to the VM to avoid overlapping pool numbers in classloader scoped
      // environments
    ...
    *
    * @param threadFactory the thread factory (setting to null causes the default thread factory
    *                      to be used)
    */
   ...
   private void validateNumerics() {
      ...
      if (idleTimeout + SECONDS.toMillis(1) > maxLifetime && maxLifetime > 0) {
         LOGGER
            .warn("{} - idleTimeout is close to or more than maxLifetime, disabling it.", poolName);
         idleTimeout = 0;
      }
      ...
      if (leakDetectionThreshold > 0 && !unitTest) {
         if (leakDetectionThreshold < SECONDS.toMillis(2) ||
   ...
   private void logConfiguration() {
      ...
      final Set<String> propertyNames =
         new TreeSet<>(PropertyElf.getPropertyNames(HikariConfig.class));
