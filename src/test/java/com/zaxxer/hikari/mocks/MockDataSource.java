...
public class MockDataSource implements DataSource {
   ...
   public static Connection createMockConnection() throws SQLException {
      ...
      when(mockConnection.prepareStatement(anyString(), (int[]) anyObject()))
         .thenReturn(mockPreparedStatement);
      when(mockConnection.prepareStatement(anyString(), (String[]) anyObject()))
         .thenReturn(mockPreparedStatement);
      ...
      //                return null;
      //            }
      //        }).doThrow(new SQLException("Connection is already closed")).when(mockConnection)
      // .close();
      ...
      //                return null;
      //            }
      //        }).doThrow(new SQLException("Transaction already commited")).when(mockConnection)
      // .commit();
      ...
      //                return null;
      //            }
      //        }).doThrow(new SQLException("Transaction already rolledback")).when
